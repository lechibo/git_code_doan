                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            @if(isset($user) && $user->avatar)
                                <img src="{{ asset('admin/images/users/'.Auth::user()->avatar) }}" alt="user" alt="user" class="rounded-circle" width="31">
                            @else
                                <img src="{{ asset('admin/images/default.png') }}" alt="default" alt="user" class="rounded-circle" width="31">
                            @endif
